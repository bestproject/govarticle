 ...
 */
class GovArticleTableContent extends JTable
{
	/**
	 * Constructor
	 *
	...
	{
		parent::__construct('#__govarticle', 'id', $db);

		JTableObserverTags::createObserver($this, array('typeAlias' => 'com_govarticle.article'));
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_govarticle.article'));
	...
	protected function _getAssetName()
	{
		...
		return 'com_govarticle.article.' . (int) $this->$k;
	}
	...
	public function check()
	{
		if (trim($this->title) == '')
		{
			$this->setError(JText::_('COM_GOVARTICLCLE_WARNING_PROVIDE_VALID_NAME'));
		...
		if (!$this->id)
		{
			...
			if (!$this->getRules())
			{
				$rules = $this->getDefaultAssetValues('com_govarticle');
				$this->setRules($rules);
			}
		}
	...
	public function store($updateNulls = false)
	{
		...
		$table = JTable::getInstance('Content', 'GovArticleTable', array('dbo', $this->getDbo()));
