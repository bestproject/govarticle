...
class GovArticleHistoryHelper {
	...
	public static function loadLanguageFiles($typeAlias) {
		...
		if (is_array($aliasArray) && count($aliasArray) == 2) {
			 ...
			 */
			$lang->load($component, JPATH_ADMINISTRATOR, null, false, true) || $lang->load($component, JPath::clean(JPATH_ADMINISTRATOR . '/components/' . $component), null, false, true);
