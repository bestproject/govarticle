 ...
 * @since  1.6
 */
class GovArticleModelArticles extends JModelList
{
	/**
	 * Constructor.
	 *
	...
	protected function getListQuery()
	{
		...
		if ($this->context != 'com_govarticle.featured')
		{
			$query->join('LEFT', '#__govarticle_frontpage AS fp ON fp.content_id = a.id');
		}
	...
	public function getItems()
	{
		...
		$globalParams = JComponentHelper::getParams('com_govarticle', true);
		...
		foreach ($items as &$item)
		{
			...
			if (!$guest)
			{
				$asset = 'com_govarticle.article.' . $item->id;
			...
			$item->tags->getItemTags('com_govarticle.article', $item->id);
		}
