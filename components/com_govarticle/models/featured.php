 ...
 * @since  1.5
 */
class GovArticleModelFeatured extends GovARticleModelArticles
{
	/**
	 ...
	 * @var		string
	 */
	public $_context = 'com_govarticle.frontpage';
	...
	protected function getListQuery()
	{
		...
		{
			$query->join('INNER', '#__govarticle_frontpage AS fp ON fp.content_id = a.id');
		}
